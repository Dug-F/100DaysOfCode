import { naturalNotes, toNaturalNote, getBaseInterval, getBaseIntervalNote, getIntervalNote, composeScale, scales } from "../scripts/algorithms.js";
...
const test3 = () => {
  const testCases = [
    ...
    { inputs: ["D♯", "dim5"], expected: "A" },
    { inputs: ["F♯", "P4"], expected: "B" },
    { inputs: ["A", "M2"], expected: "B" },
    { inputs: ["C", "unison"], expected: "C" },
    { inputs: ["F♯", "unison"], expected: "F" },
    { inputs: ["F♯", "M2"], expected: "G" },
  ];

  runTestCases(getBaseIntervalNote, testCases);
};
