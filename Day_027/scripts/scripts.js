...
const submenus = new Set(["Chords", "Intervals"]);
...
function fadeElement(element) {
  ...
  if (!innerLabels[circleStatus.currentScale][circleStatus.currentInnerLabels][element.dataset.position]) {
...
createArmNode(centre, "innerLabel", innerLabels[circleStatus.currentScale][circleStatus.currentInnerLabels]);
