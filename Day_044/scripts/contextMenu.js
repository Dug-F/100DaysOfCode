...
import { updatePositionNumbers, populateBubbles, getElementRect } from "./helperFunctions.js";
import { rotateBubbles } from "./rotations.js";
...
const callbackMakeTonic = (event) => {
  ...
  updatePositionNumbers(container, ".bubble.note", -position);
  ...
  drawChords(position);
  rotateBubbles(position, `.label.bubble`);
