import { circleStatus, svgContainer, container, chordPatternsInScale, 
  chordShapes, intervalToPosition, updateHeader, getConnector } from "./dataStructure.js";
...
export const drawChords = (position) => {
  ...
  circleStatus.currentChordShape = chordShape;
